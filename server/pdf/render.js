 ...
 */
export async function renderFinanceMemoPdf({ payload, coverImage, logo, propertyImages }) {
  ...
  try {
    ...
    const pdf = await page.pdf({
      ...
      footerTemplate: `
        <div style="font-size:9px;width:100%;padding:0 14mm;color:#6b7280;display:flex;justify-content:space-between;">
          <div>${escapeHtml(payload?.footers?.confidentiality || '')}</div>
