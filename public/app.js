...
function renderRepeater(type) {
  const map = {
    ...
    execSummary: { list: '#execSummaryList', tpl: 'tplExecRow', blank: { key: '', value: '' } },
    ...
    funding: { list: '#fundingList', tpl: 'tplSimpleRow', blank: { label: '', amount: '' } },
    ...
    companyAssets: { list: '#companyAssetsList', tpl: 'tplSimpleRow', blank: { label: '', amount: '' } },
    companyLiabilities: { list: '#companyLiabilitiesList', tpl: 'tplSimpleRow', blank: { label: '', amount: '' } },
  };
  const cfg = map[type];
  if (!cfg) return;
