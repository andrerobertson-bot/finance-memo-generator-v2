...
(3) Construction contract`);
  ...
  // Cover defaults
  setIfEmpty('cover.mainTitle', 'Global Capital Commercial');
  setIfEmpty('cover.subheadline1', 'Confidential');
  setIfEmpty('cover.subheadline2', 'Finance Memorandum');
  setIfEmpty('cover.headline', 'Construction Finance');
  setIfEmpty('cover.proposalText', 'PROPOSAL');
  setIfEmpty('cover.imageFitMode', 'smart');
  setIfEmpty('cover.showOverlayLogo', 'false');
  setIfEmpty('cover.showOverlayProposal', 'false');
  setIfEmpty('cover.showFooterOnCover', 'false');
  setIfEmpty('cover.website', 'globalcapital.com.au');
  setIfEmpty('cover.legalLine', 'Global Capital Corporation Pty Ltd | ABN 14 097 482 114 | Telephone 612 9222 9100 | info@globalcapital.com.au');
  setIfEmpty('cover.addressLine', 'Level 43 Governor Phillip Tower, 1 Farrer Place Sydney, NSW Australia 2000 | PO Box R196 Royal Exchange NSW 1225');
})();
...
$('#btnLoadSample').addEventListener('click', () => {
  ...
  set('cover.mainTitle', 'Global Capital Commercial');
  set('cover.subheadline1', 'Confidential');
  set('cover.subheadline2', 'Finance Memorandum');
  set('cover.headline', 'Construction Finance');
  set('cover.projectName', 'Warra Project Pty Ltd');
